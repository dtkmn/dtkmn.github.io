---
title: "Quarkus Native vs. Go for AdTech Throughput"
...
> **Editor's note (March 12, 2026):** This article captures an early benchmark snapshot from November 12, 2025, when the repo compared Quarkus Native, Go, and a traditional Spring baseline under a much narrower setup. The project has since grown into a broader benchmark harness with Quarkus JVM/native, Go, Rust, Python/FastAPI, Spring Boot 4, and Node/Fastify, plus separate `http-only`, `enqueue`, and Kafka-confirmed modes. Treat the numbers below as a historical milestone, not the current benchmark conclusion. For the updated framing, read [What Microservice Benchmarks Measure in 2026](/posts/what-microservice-benchmarks-actually-measure-in-2026/).
...
- [What Microservice Benchmarks Measure in 2026](/posts/what-microservice-benchmarks-actually-measure-in-2026/)
