...
archiveReason: Old Docker quickstart; useful context, but not current Kafka architecture guidance.
heroImage: /images/posts/kafka-quickstart/local-cluster.png
---
...
![Kafka cluster running locally](/images/posts/kafka-quickstart/local-cluster.png)
