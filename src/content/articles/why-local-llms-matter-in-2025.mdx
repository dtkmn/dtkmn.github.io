...
That is why this essay belongs next to the [LLM AI Assistant](https://github.com/dtkmn/llm-ai-assistant) project. Private document analysis, local retrieval, and on-device experimentation all depend on the same architectural choice: decide deliberately where the model runs, where the data lives, and what leaves the machine.
