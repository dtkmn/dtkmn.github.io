...
That is why this essay belongs next to [Loopwright](/projects/loopwright/). The project is deliberately practical: evidence routing, retrieval, verifier decisions, retries, refusals, replay, and model execution you can inspect. It is a private-AI boundary test, not just another chat UI.
