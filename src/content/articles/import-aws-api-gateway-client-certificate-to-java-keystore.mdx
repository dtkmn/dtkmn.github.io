...
archiveReason: Narrow 2020 TLS walkthrough; useful for long-tail reference, but too small to represent the current platform point of view.
heroImage: /images/posts/aws-api-gateway-keystore/client-certificate.png
---
...
![Copy the certificate content](/images/posts/aws-api-gateway-keystore/client-certificate.png)
